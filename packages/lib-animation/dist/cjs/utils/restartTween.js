...
exports.restartTween = restartTween;
 ...
 */
function restartTween(store, storeId, tweenAttribute, startTime) {
  ...
  store.float32Array[(store.getByteOffsetAttr(storeId, tweenAttribute) + 4) / 4] = startTime;
  return startTime;
}