 ...
 * Licensed under the MIT license. See LICENSE file in the project.
 */
export declare enum CameraAdjustmentMode {
    /**
 ...
 */
export declare type ColorVector = [number, number, number, number];
/**
 ...
 */
export declare type Bounds = Bounds2D & Partial<Bounds3D>;
/**
