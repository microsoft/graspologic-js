...
class RenderConfigurationImpl {
  constructor() {
    _defineProperty(this, "_drawEdges", new PropertyContainer(DEFAULT_DRAW_EDGES));

    _defineProperty(this, "_hideEdgesOnMove", new PropertyContainer(DEFAULT_HIDE_EDGES_ON_MOVE));

    _defineProperty(this, "_drawNodes", new PropertyContainer(DEFAULT_DRAW_NODES));

    _defineProperty(this, "_hideNodesOnMove", new PropertyContainer(DEFAULT_HIDE_NODES_ON_MOVE));

    _defineProperty(this, "_hideDeselected", new PropertyContainer(DEFAULT_HIDE_DESELECTED));

    _defineProperty(this, "_is3D", new PropertyContainer(DEFAULT_IS_3D));

    _defineProperty(this, "_backgroundColor", new PropertyContainer(DEFAULT_BG_COLOR, areColorsEqual));

    _defineProperty(this, "_edgeConstantWidth", new PropertyContainer(DEFAULT_EDGE_CONSTANT_WIDTH));

    _defineProperty(this, "_edgeDepthWrite", new PropertyContainer(DEFAULT_EDGE_DEPTH_WRITE));

    _defineProperty(this, "_edgeAntialias", new PropertyContainer(DEFAULT_EDGE_ANTIALIAS));

    _defineProperty(this, "_edgeAlpha", new PropertyContainer(DEFAULT_EDGE_ALPHA));

    _defineProperty(this, "_edgeMinWidth", new PropertyContainer(DEFAULT_EDGE_MIN_WIDTH));

    _defineProperty(this, "_edgeMaxWidth", new PropertyContainer(DEFAULT_EDGE_MAX_WIDTH));

    _defineProperty(this, "_edgeFilteredOutSaturation", new PropertyContainer(DEFAULT_EDGE_FILTERED_OUT_SATURATION));

    _defineProperty(this, "_edgeFilteredInSaturation", new PropertyContainer(DEFAULT_EDGE_FILTERED_IN_SATURATION));

    _defineProperty(this, "_nodeMinRadius", new PropertyContainer(DEFAULT_NODE_MIN_RADIUS));

    _defineProperty(this, "_nodeMaxRadius", new PropertyContainer(DEFAULT_NODE_MAX_RADIUS));

    _defineProperty(this, "_nodeOutline", new PropertyContainer(DEFAULT_NODE_OUTLINE));

    _defineProperty(this, "_nodeFilteredOutSaturation", new PropertyContainer(DEFAULT_NODE_FILTERED_OUT_SATURATION));

    _defineProperty(this, "_nodeFilteredInSaturation", new PropertyContainer(DEFAULT_NODE_FILTERED_IN_SATURATION));

    _defineProperty(this, "_nodeFilteredIds", new PropertyContainer(undefined));

    _defineProperty(this, "_nodeCountHint", new PropertyContainer(DEFAULT_NODE_COUNT_HINT));

    _defineProperty(this, "_edgeCountHint", new PropertyContainer(DEFAULT_EDGE_COUNT_HINT));

    _defineProperty(this, "_width", new PropertyContainer(DEFAULT_WIDTH));

    _defineProperty(this, "_height", new PropertyContainer(DEFAULT_HEIGHT));

    _defineProperty(this, "_dataBounds", new PropertyContainer(DEFAULT_BOUNDS));

    _defineProperty(this, "_cornerAxes", new PropertyContainer(DEFAULT_CORNER_AXES));

    _defineProperty(this, "_drawAxes", new PropertyContainer(DEFAULT_DRAW_AXES));

    _defineProperty(this, "_interpolationTime", new PropertyContainer(DEFAULT_INTERPOLATION_TIME));

    _defineProperty(this, "_hoverHighlightColor", new PropertyContainer(DEFAULT_HOVER_HIGHLIGHT_COLOR));

    _defineProperty(this, "_autoBind", new PropertyContainer(DEFAULT_AUTO_BIND));

    _defineProperty(this, "_cameraAdjustmentMode", new PropertyContainer(DEFAULT_CAMERA_MODE));
  }
