 ...
 */
function getShaders(vs, defines = {}) {
    return {
        vs: vs,
        fs: edgeFS,
        modules: [tween],
 ...
 * @param defines The set of defines to pass to the compiler
 */
export default function createModel(gl, id, vs, defines = {}) {
    ...
    const { buffer, attributes } = adaptMemoryLayoutToLuma(gl, edgeMemoryLayout, GL_TYPE_MAPPINGS);
    return {
        model: new Model(gl, {
