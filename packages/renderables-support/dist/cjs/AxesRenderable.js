...
class AxesRenderable extends _renderablesEdges.EdgesRenderable {
  /**
   * Constructor
  ...
  generateEdges() {
    ...
    const edgesBuffer = (0, _graph.createEdgeStore)({
      capacity: axisCount
    });
    this.data = edgesBuffer;
    this.projection = new _math.Matrix4().ortho({
      left: -0.5 * this.width,
...
exports.AxesRenderable = AxesRenderable;