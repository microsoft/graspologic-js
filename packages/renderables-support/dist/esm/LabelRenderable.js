...
import labelVS from '@graspologic/renderer-glsl/dist/esm/shaders/label.vs.glsl'; // We have no equivalent in the typings
...
export class LabelRenderable extends DirtyableRenderable {
  ...
  constructor(gl) {
    ...
    _defineProperty(this, "_text", new PropertyContainer(''));

    _defineProperty(this, "_font", new PropertyContainer('monospace'));

    _defineProperty(this, "_fontSize", new PropertyContainer(18));

    _defineProperty(this, "_weight", new PropertyContainer(0));

    _defineProperty(this, "_horizontalPadding", new PropertyContainer(8));

    _defineProperty(this, "_verticalPadding", new PropertyContainer(2));

    _defineProperty(this, "_outline", new PropertyContainer(4));

    _defineProperty(this, "_backgroundColor", new PropertyContainer('rgb(134, 135, 159)'));

    _defineProperty(this, "_outlineColor", new PropertyContainer('rgb(107, 108, 127)'));

    _defineProperty(this, "_textColor", new PropertyContainer('rgb(240, 241, 255)'));
  ...
  _createModel(gl, id) {
    ...
    vertices.push(1, 1, 0);
    UVs.push(1, 0);
    return new Model(gl, _objectSpread(_objectSpread({}, this._getShaders()), {}, {
      id: id,
