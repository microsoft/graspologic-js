...
exports.computeRepulsionUnoptimized = computeRepulsionUnoptimized;
 ...
 */
function computeRepulsionUnoptimized(nodes, config) {
  // O(n^2) iteration
  let nid1;
  let nid2;
  ...
  for (nid1 = 0; nid1 < nodes.count; ++nid1) {
    for (nid2 = 0; nid2 < nid1; ++nid2) {
      (0, _computeNodeRepulsion.computeNodeRepulsion)(nodes.itemAt(nid1), nodes.itemAt(nid2), config);
    }
  }
