...
exports.MemoryReaderInspector = void 0;
...
class MemoryReaderInspector {
  ...
  readNumber(item, attribute) {
    if (!item.layout.has(attribute)) {
      ...
      if (attrib.type === _specification.AttributeType.Uint8) {
        return this.readUint8Attr(item, attribute);
      } else if (attrib.type === _specification.AttributeType.Uint32) {
...
exports.MemoryReaderInspector = MemoryReaderInspector;