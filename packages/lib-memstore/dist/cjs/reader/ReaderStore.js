...
exports.ReaderStoreImpl = void 0;
 ...
 */
class ReaderStoreImpl extends _store.IdStoreImpl {
  /**
   ...
   */
  constructor(itemClass, store, allocator = new _store.SlotAllocator(store.config.capacity)) {
...
exports.ReaderStoreImpl = ReaderStoreImpl;