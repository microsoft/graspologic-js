...
class IdStoreImpl {
  ...
  constructor(store, allocator) {
    ...
    _defineProperty(this, "slotAllocator", void 0);

    _defineProperty(this, "onUpdateHandlers", []);

    _defineProperty(this, "onAddHandlers", []);

    _defineProperty(this, "onRemoveHandlers", []);
...
exports.IdStoreImpl = IdStoreImpl;