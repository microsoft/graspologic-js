...
const DEFAULT_OPTIONS = {
  shared: _defaults.DEFAULT_SHARED,
  capacity: _defaults.DEFAULT_CAPACITY
};
/**
...
class ArrayStoreImpl {
  ...
  constructor(layout, options = DEFAULT_OPTIONS) {
    ...
    const capacity = options.capacity || (((_options$buffer = options.buffer) === null || _options$buffer === void 0 ? void 0 : _options$buffer.byteLength) || 0) / layout.stride || _defaults.DEFAULT_CAPACITY;
    this.config = {
      capacity,
      shared: typeof options.shared === 'boolean' ? options.shared : _defaults.DEFAULT_SHARED
    };
...
exports.ArrayStoreImpl = ArrayStoreImpl;