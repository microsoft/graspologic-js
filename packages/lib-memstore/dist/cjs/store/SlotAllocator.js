...
class SlotAllocator {
   ...
   */
  constructor(capacity = _defaults.DEFAULT_CAPACITY, consumed = false) {
    _defineProperty(this, "availableIndices", new Map());

    _defineProperty(this, "nextAvailableIndex", void 0);
...
exports.SlotAllocator = SlotAllocator;