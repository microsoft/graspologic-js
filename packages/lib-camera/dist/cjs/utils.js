...
exports.computeCameraPosition = computeCameraPosition;
 ...
 */
function computeCameraPosition(bounds, fov, aspect) {
  const transformed = new _math.Matrix4().perspective({
    fov,
    aspect
  }).invert().transform([1, 1], undefined);
  ...
  return new _math.Vector3(-midX, -midY, -minDist);
}