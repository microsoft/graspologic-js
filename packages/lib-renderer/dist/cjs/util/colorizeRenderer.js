...
exports.colorizeRenderer = colorizeRenderer;
exports.componentColorToBGRA = componentColorToBGRA;
exports.correctColor = correctColor;
exports.createBGRAColorizer = createBGRAColorizer;
...
function createBGRAColorizer(colorizerFn = () => 0xff0000ff) {
  return (id, group) => {
...
function colorizeRenderer(renderer, colorizerFn) {
...
function componentColorToBGRA(components) {
