...
export declare type InitializeHandler<T> = (context: T) => void;
/**
...
export declare enum VisualDimensions {
    TwoD = "2D",
    ThreeD = "3D"
}
/**
 ...
 */
export declare type NodeComponentColorizer = (id: Maybe<Id>, group: Maybe<Id>) => [number, number, number, number];
/**
 ...
 */
export declare type NodeBGRAColorizer = (id: Maybe<Id>, group: Maybe<Id>) => number;
/**
 * Provides a color for the given node
 * @param id The id of the node
 * @param group The group of the node
 ...
 */
export declare type NodeColorizer = (id: Maybe<Id>, group: Maybe<Id>) => [number, number, number, number] | number;
