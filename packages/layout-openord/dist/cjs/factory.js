...
var _AnnealingClock = require("./AnnealingClock");

var _DensityGrid = require("./DensityGrid");
...
function createInstance(graph, configuration = {}, globalObject = window) {
  ...
  return new _OpenOrdLayoutExecutor.OpenOrdLayoutExecutor(graph, finalConfig, new _AnnealingClock.AnnealingClock(configuration.edgeCut, configuration.schedule), globalObject, new _DensityGrid.DensityGrid());
}