...
exports.RADIUS = exports.GRID_SIZE = exports.FALLOFF = exports.DensityGrid = exports.DIAMETER = void 0;
...
class DensityGrid {
  constructor() {
    ...
    _defineProperty(this, "_bitmap", getInitialDensityBitmap());

    _defineProperty(this, "_bins", getInitialDensityBins());

    _defineProperty(this, "_trackedNodes", new Set());
  }
      ...
      for (j = xGrid - 1; j <= xGrid + 1; ++j) {
        ...
        for (id of Object.keys(bin)) {
          ...
          if (parseInt(id, 10) !== node.storeId) {
            ...
            const distance = (0, _graph.squareDistanceTo)(position, binItemPos);
    ...
    for (i = yGrid - 1; i <= yGrid + 1; ++i) {
      for (j = xGrid - 1; j <= xGrid + 1; ++j) {
        ...
        for (id of Object.keys(bin)) {
          ...
          if (parseInt(id, 10) !== node.storeId) {
            const other = bin[id];
            const distance = (0, _graph.distanceTo)(position, other);
...
exports.DensityGrid = DensityGrid;
